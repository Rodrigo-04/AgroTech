    ...
    >
      ...
      {typeof umidadeSolo === 'number' && (
        <VictoryLine
          ...
          style={{
            data: {
              stroke: '#8B4513', // Marrom
              strokeWidth: 2     // Espessura um pouco menor que a linha principal
            }
          }}
        />
      )}
      ...
      <VictoryLine 
        ...
        style={{ 
          data: { 
            stroke: '#8B4513', // Linha marrom
            strokeWidth: 2    // Espessura maior para destacar
          } 
        }} 
              ...
              {/* <View style={styles.card}>
                ...
                <View style={styles.chartContainer}>
                  <VictoryChart 
                    theme={VictoryTheme.material}
                    domainPadding={20}
                    domain={{ y: [0, 100] }} // Definindo escala fixa de 0 a 100%
                  >
                    <VictoryAxis
                      fixLabelOverlap
                      style={{
                    ...
                    <VictoryAxis 
                      dependentAxis
                      tickValues={[0, 20, 40, 60, 80, 100]} // Valores fixos no eixo Y
                      tickFormat={(y) => `${y}%`} // Adiciona % aos valores
                    />
                    <VictoryLine 
                      data={dadosUmidadeSolo} 
                      style={{ 
                      ...
                      interpolation="natural" // Suaviza a linha
                    />
                  </VictoryChart>
                </View>
              </View> */}
